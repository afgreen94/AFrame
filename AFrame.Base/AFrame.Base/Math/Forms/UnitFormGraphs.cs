...
namespace AFrame.Base.Math.Forms
{
    ...
    //{
    //    public override abstract IUnitFormGraph.IDescription Description { get; }
    //}

    //public class UnitFormGraphDescription : GraphDescription, IUnitFormGraph.IDescription { }
    ...
    //        };
    //        private static readonly IGraph graph = new HashSetGrapht2D()
    //        {
    //            Vertices = new HashSet<IPoint2D>(vertices),
    //            Edges = new HashSet<IEdge<IPoint2D>>(edges)
    //        };

    //        public override IUnitFormGraph.IDescription Description => Descriptions.Square;
    //    }

    //    public class Descriptions
    //    {
    //        public readonly static IUnitFormGraph.IDescription Square = new UnitFormGraphDescription()
    //        {
